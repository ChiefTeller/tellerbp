...
- Author: נדב טלר
- Language: he
- Canonical reader: https://tellerbp.co.il/unified-state-reader.html
- Content scope: הטקסט באתר כולל את עמודים 1-158 ואת פרק שלושה-עשר: מערכת בריאותית מניעתית.
...
עברית · מאת נדב טלר · עד פרק שלושה-עשר כולל

תורת זוגא המדינה האחודה | מאת נדב טלר
...
תורת המדינה האחודה מוסיפה נדבך נוסף למודל סוכני הקונצרן, כאשר היא מאפשרת לכל יהודי ולכל ישראלי ברחבי העולם להפוך לסוכני הקונצרן, בהתאם למדדים הבוחנים את תרומתם לגלגלי התנופה וליתר זרועות הקונצרן.
...
תורת המדינה האחודה מציעה להקים מנגנון חדש, שלושה שכבות ניהול, פיקוח והתבוננות, הנהלה ששומרים על המטרות השונות של הקונצרן הלאומי האחוד. הנהלת הקונצרן מנהלת ומבצעת, הדירקטוריון המקצועי מפקח על איכות הניהול, הנדבך הכלכלי והסיכונים, מועצת החכמים מפקחת על משמעות, האיזון והריסון העצמי של הקונצרן הלאומי האחוד.
